  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (params.userid) {
        ...
        console.log("fetcged data", fetchedData);
        ...
        <div className="relative">
          ...
          <div className="max-w-6xl mx-auto pt-8 pb-8 px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-black text-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4">{userData?.name}</h3>
              <p>
                I am {userData?.name}. I love Japan and anime woman. I talk
                Japanese, and I am from Bangalore.
              </p>
